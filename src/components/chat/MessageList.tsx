  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <p className="text-neutral-900 text-lg mb-2 text-center w-full" style={{ fontFamily: "'MedievalSharp', serif" }}>Start a conversation to generate React components</p>
        <p className="text-neutral-500 text-sm max-w-sm text-center mx-auto" style={{ fontFamily: "'MedievalSharp', serif" }}>I can help you create buttons, forms, cards, and more</p>
      </div>
    );
  }
